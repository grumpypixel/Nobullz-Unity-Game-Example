...
namespace game
{
	...
	{
		private static BallFactory			m_ballFactory;
		...
		public static BallFactory ballFactory { get { return m_ballFactory; } }
		...
		{
			m_ballFactory = GameObject.FindObjectOfType<BallFactory>();
